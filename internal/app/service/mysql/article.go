...
func (m *ArticleModel) Insert(name, email, password string) error {
...
func (m *ArticleModel) Authenticate(email, password string) (int, string, error) {
	var id int
	var name string
...
func (m *ArticleModel) Get(id int) (*models.User, error) {
	s := &models.User{}
